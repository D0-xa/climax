...
class _SettingsDialogState extends State<SettingsDialog> {
  ...
  Widget build(BuildContext context) {
    ...
    return AlertDialog.adaptive(
      ...
      backgroundColor: _darkMode ? Color(0xff494d50) : null,
      icon: Row(
        children: [
          Expanded(
            flex: 4,
        ...
        children: [
          ListTile(
            ...
            leading: Stack(
              ...
              children: [
                ...
                CircleAvatar(
                  backgroundColor:
                      _darkMode ? const Color(0xff343637) : Colors.white,
                  radius: 10.5,
                  child: Container(
          ...
          ListTile(
            ...
            leading: SizedBox(
              ...
              child: Icon(
                ...
                color: _darkMode ? Colors.white70 : const Color(0xff575757),
                size: 20.0,
              ),
            ),
            title: Text(
          ...
          AnimatedSize(
            ...
            child: Container(
              height: _height,
              decoration: BoxDecoration(
                color: _darkMode ? const Color(0xff343637) : Colors.white,
                borderRadius: BorderRadius.circular(2.0),
              ),
